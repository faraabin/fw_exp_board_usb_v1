...
از [اینجا](https://www.aparat.com/faraabinco) میتوانید فیلم توضیح فرابین و کار با برد تجربه را ببینید.
...
این برنامه در محیط‌ توسعه Keil ارائه شده است.

برای بارگذاری برنامه نیز کاربران می‌توانند از کانکتور JTAG موجود روی برد (به صورت SMD PAD) استفاده کنند. راهنمای پین های این کانکتور (X2) در شکل زیر مشخص شده است.
![prg pinout](https://github.com/user-attachments/assets/e4a56cde-3648-48f8-b626-b109e03592d1)
