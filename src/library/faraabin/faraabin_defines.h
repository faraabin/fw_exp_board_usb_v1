...
#define fFaraabin_Init()  0
#define fFaraabin_Enable()
#define fFaraabin_Disable()
#define fFaraabin_Run()
#define fFaraabin_CharReceived(c_)
#define fFaraabin_PasswordSet(password_)
#define fFaraabin_PasswordEnable()
#define fFaraabin_PasswordDisable()
#define fFaraabin_IsHostConnected() false
#define fFaraabin_IsAllowEvent()  false
#define fFaraabin_FlushBuffer()
#endif
...
#define FARAABIN_VAR_ENUM_WP_(varName_, type_, path_)
#define FARAABIN_VAR_ENUM_(varName_, type_)
#define FARAABIN_VAR_ENUM_CB_WP_(varName_, type_, fpAccessCb_, path_)
#define FARAABIN_VAR_ENUM_CB_(varName_, type_, fpAccessCb_)
#define FARAABIN_VAR_ENUM_ARRAY_WP_(varName_, type_, path_)
#define FARAABIN_VAR_ENUM_ARRAY_(varName_, type_)
#define FARAABIN_VAR_ENUM_ARRAY_CB_WP_(varName_, type_, fpAccessCb_, path_)
#define FARAABIN_VAR_ENUM_ARRAY_CB_(varName_, type_, fpAccessCb_)
#define FARAABIN_VAR_STRUCT_WP_(varName_, type_, path_)
#define FARAABIN_VAR_STRUCT_(varName_, type_)
#define FARAABIN_VAR_STRUCT_CB_WP_(varName_, type_, fpAccessCb_, path_)
#define FARAABIN_VAR_STRUCT_CB_(varName_, type_, fpAccessCb_)
#define FARAABIN_VAR_STRUCT_ARRAY_WP_(varName_, type_, path_)
#define FARAABIN_VAR_STRUCT_ARRAY_(varName_, type_)
#define FARAABIN_VAR_STRUCT_ARRAY_CB_WP_(varName_, type_, fpAccessCb_, path_)
#define FARAABIN_VAR_STRUCT_ARRAY_CB_(varName_, type_, fpAccessCb_)
#endif
...
#define FARAABIN_VAR_BOOL_WP_(varName_, path_)
#define FARAABIN_VAR_BOOL_(varName_)
#define FARAABIN_VAR_BOOL_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_BOOL_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U8_WP_(varName_, path_)
#define FARAABIN_VAR_U8_(varName_)
#define FARAABIN_VAR_U8_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U8_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U16_WP_(varName_, path_)
#define FARAABIN_VAR_U16_(varName_)
#define FARAABIN_VAR_U16_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U16_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U32_WP_(varName_, path_)
#define FARAABIN_VAR_U32_(varName_)
#define FARAABIN_VAR_U32_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U32_CB_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U64_WP_(varName_, path_)
#define FARAABIN_VAR_U64_(varName_)
#define FARAABIN_VAR_U64_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U64_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I8_WP_(varName_, path_)
#define FARAABIN_VAR_I8_(varName_)
#define FARAABIN_VAR_I8_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I8_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I16_WP_(varName_, path_)
#define FARAABIN_VAR_I16_(varName_)
#define FARAABIN_VAR_I16_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I16_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I32_WP_(varName_, path_)
#define FARAABIN_VAR_I32_(varName_)
#define FARAABIN_VAR_I32_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I32_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I64_WP_(varName_, path_)
#define FARAABIN_VAR_I64_(varName_)
#define FARAABIN_VAR_I64_CB_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I64_CB_WP_(varName_, fpAccessCb_)
#define FARAABIN_VAR_F32_WP_(varName_, path_)
#define FARAABIN_VAR_F32_(varName_)
#define FARAABIN_VAR_F32_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_F32_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_F64_WP_(varName_, path_)
#define FARAABIN_VAR_F64_(varName_)
#define FARAABIN_VAR_F64_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_F64_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_BOOL_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_BOOL_ARRAY_(varName_)
#define FARAABIN_VAR_BOOL_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_BOOL_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U8_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_U8_ARRAY_(varName_)
#define FARAABIN_VAR_U8_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U8_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U16_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_U16_ARRAY_(varName_)
#define FARAABIN_VAR_U16_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U16_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U32_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_U32_ARRAY_(varName_)
#define FARAABIN_VAR_U32_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U32_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_U64_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_U64_ARRAY_(varName_)
#define FARAABIN_VAR_U64_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_U64_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I8_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_I8_ARRAY_(varName_)
#define FARAABIN_VAR_I8_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I8_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I16_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_I16_ARRAY_(varName_)
#define FARAABIN_VAR_I16_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I16_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I32_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_I32_ARRAY_(varName_)
#define FARAABIN_VAR_I32_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I32_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_I64_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_I64_ARRAY_(varName_)
#define FARAABIN_VAR_I64_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_I64_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_F32_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_F32_ARRAY_(varName_)
#define FARAABIN_VAR_F32_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_F32_ARRAY_CB_(varName_, fpAccessCb_)
#define FARAABIN_VAR_F64_ARRAY_WP_(varName_, path_)
#define FARAABIN_VAR_F64_ARRAY_(varName_)
#define FARAABIN_VAR_F64_ARRAY_CB_WP_(varName_, fpAccessCb_, path_)
#define FARAABIN_VAR_F64_ARRAY_CB_(varName_, fpAccessCb_)
